class RecipesController < ApplicationController
    ...
    def recipe_params
        params.require(:recipe).permit(:false, :title, :chef_id, :meal_category, ingredients_attributes: [:id, :name, :quantity, :_destroy], cooking_steps_attributes: [:id, :content, :_destroy])
    end
